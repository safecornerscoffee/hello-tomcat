    ...
    <div class="column">
      ...
      <nav class="level">
        <div class="level-left">
          <p class="level-item">
            <a class="button is-success" href="${pageContext.request.contextPath}/users/new">New</a>
          </p>

          <div class="level-item is-hidden-tablet-only">
            <div class="field has-addons">
              <p class="control">
                <input class="input" placeholder="User #, email..." type="text">
              </p>
              <p class="control">
      ...
      <table class="table is-hoverable is-fullwidth">
        ...
        <tbody>
          <c:forEach var="user" items="${users}">
            <tr>
              <td>
                <a href="${pageContext.request.contextPath}/users/${user.id}">${user.id}</a>
              </td>
              <td>
                <a href="${pageContext.request.contextPath}/users/${user.id}">${user.username}</a>
              </td>
              <td>
                  ${user.email}
              </td>
